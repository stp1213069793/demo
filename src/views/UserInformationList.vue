...
<div class="userInfo">
    ...
    <div class="userInfo-main">
        <div class="title">
            <el-table :data="tableData" :header-cell-style="{ textAlign: 'center' }" :cell-style="{ textAlign: 'center' }" stripe size="small" style="width: 100%">
                ...
                <el-table-column label="city" width="100">
                    <template slot-scope="scope">
                        <span>{{
                look(formData(scope.row.cityNo, provinceData(scope.row.provinceNo)))
               ...
               look( formData(
                ...
                <el-table-column label="operation" width="180">
                    <template slot-scope="scope">
                        <el-button size="mini" @click="uerDdetails(scope.row)">详情</el-button>
                        <el-button size="mini" type="danger" @click="handleDelete(scope.$index, scope.row)">权限</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
    ...
    <div class="userInfo-pages">
        <el-pagination background layout="prev, pager, next" @size-change="handleSizeChange" @current-change="handleCurrentChange" :total="count">
        </el-pagination>
